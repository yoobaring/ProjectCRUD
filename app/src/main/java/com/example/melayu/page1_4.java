...
public class page1_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page1_4);
        mySong1 = MediaPlayer.create(page1_4.this, R.raw.f1);
        mySong2 = MediaPlayer.create(page1_4.this, R.raw.f2);
        mySong3 = MediaPlayer.create(page1_4.this, R.raw.f3);
        mySong4 = MediaPlayer.create(page1_4.this, R.raw.f4);
        mySong5 = MediaPlayer.create(page1_4.this, R.raw.f5);
        mySong6 = MediaPlayer.create(page1_4.this, R.raw.f6);
        mySong7 = MediaPlayer.create(page1_4.this, R.raw.f7);
        mySong8 = MediaPlayer.create(page1_4.this, R.raw.f8);
        mySong9 = MediaPlayer.create(page1_4.this, R.raw.f9);
        mySong10 = MediaPlayer.create(page1_4.this, R.raw.f10);
        mySong11 = MediaPlayer.create(page1_4.this, R.raw.f11);
        mySong12 = MediaPlayer.create(page1_4.this, R.raw.f12);
